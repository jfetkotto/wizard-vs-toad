...
function love.conf(t)
    ...
    t.title = "Wizard Vs Toad"      			-- The title of the window the game is in (string)
    t.author = "omfgitsatoad@gmail.com"			-- The author of the game (string)
	...
	t.identity = "omfg-Wizard"					-- Set the save directory
end
