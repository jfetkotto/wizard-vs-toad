WinScreen = Game:addState("WinScreen")

function WinScreen:enterState()
	WinScreen.score = Player:getScore()
end
...
function WinScreen:draw()
	...
	love.graphics.printf(
		"Congratulations\n" .. 
		"You beat the toad\n\n" .. 
		"Score: " .. WinScreen.score, 0,Font.title_font:getHeight()/2, GameWidth, 'center')
end
